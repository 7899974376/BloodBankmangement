	    ...
	    <ul class="ts-sidebar-menu">
	        ...
	        <li><a href="#"><i class="fa fa-files-o"></i> Blood Group</a>
	            <ul>
	                ...
	                <li><a href="manage-bloodgroup.php">Blood Group</a></li>
	            </ul>
	        </li>
	        ...
	        <li><a href="manage-conactusquery.php"><i class="fa fa-desktop"></i> Conatctus Query</a></li>
	        <li><a href="manage-pages.php"><i class="fa fa-files-o"></i> Pages</a></li>
