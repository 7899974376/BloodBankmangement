...
<body>
    ...
    <div class="login-page bk-img"
        style="background-image: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)),url(img/banner.jpg);">
        <div class="form-content">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <h1 class="text-center text-white mt-4x">ADMIN</h1>
                        <div class="row pt-2x pb-3x">
                            <div class="col-md-8 col-md-offset-2">
                                ...
                                <!-- <div class="card-footer text-center" style="padding-top: 30px;">
									<div class="small"><a href="../index.php" class="btn btn-primary">Back to Home</a>
									</div>
								</div> -->
                            </div>
                        </div>
