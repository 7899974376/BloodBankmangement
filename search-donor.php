            ...
            <div class="agileits-contact py-5">
                <div class="py-xl-5 py-lg-3">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="row package-grids mt-5 justify-content-around" style="padding-left: 50px;">
                            <?php foreach ($results as $result) { ?>
                            <div class="col-md-4 mx-2 mb-5 pricing">

                                <div class="price-top">
                                    <a href="single.html">
                                        <img src="images/blood-donor.jpg" alt="Blood Donor"
                                            style="border:1px #000 solid" class="img-fluid" />
                                    </a>
                                    <h3>
